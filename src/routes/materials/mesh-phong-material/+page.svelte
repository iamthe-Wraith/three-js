...
onMount(async () => {
   ...
   * 
   * useful for simulating shiny surfaces like polished wood.
   * 
   * is more computationally expensive than the lambert, normal or basic
   * materials, so if performance is a concern, consider only using this
