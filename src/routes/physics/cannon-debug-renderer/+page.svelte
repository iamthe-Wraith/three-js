  ...
  onMount(async () => {
    ...
    objLoader.load(
      ...
      (object) => {
        ...
        /**
         * you can use convex polyhedrons to increase the types of shapes
         * it can collide with, but it is much less performant. better to
         * use trimeshes or "simpler" object types to increase performance
         * 
         * @see https://sbcode.net/threejs/physics-cannonjs/
         * 
         * when using convex polyhedrons, you should try to keep the shapes
         * simple, with no inward facing faces.
        */
