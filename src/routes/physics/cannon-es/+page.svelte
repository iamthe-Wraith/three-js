<script lang="ts" type="module">
  ...
  /**
   * cannon-es is a physics engine that is a port of the original cannon.js.
  */
  ...
  onMount(async () => {
    ...
    function animate() {
        ...
        /**
         * clamp the clock.delta to 0.1 because when you leave the screen 
         * (like going to another tab or something), the animation loop is
         * not executing, so when you come back, the delta is much higher,
         * and the simulation goes bananas.
        */
