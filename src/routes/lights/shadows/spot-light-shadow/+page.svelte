<script lang="ts" type="module">
  ...
  */
  ...
  onMount(async () => {
    ...
    const helper = new THREE.CameraHelper(light.shadow.camera); // <<< shadow is a camera, so need to use camera helper here
    scene.add(helper)
    ...
    plane.receiveShadow = true; // objects need to be configured to cast or receive shadows
    scene.add(plane)
    ...
    torus[0].castShadow = true // objects need to be configured to cast or receive shadows
    torus[1].castShadow = true // objects need to be configured to cast or receive shadows
    torus[2].castShadow = true // objects need to be configured to cast or receive shadows
    torus[3].castShadow = true // objects need to be configured to cast or receive shadows
    torus[4].castShadow = true // objects need to be configured to cast or receive shadows

    torus[0].receiveShadow = true // objects need to be configured to cast or receive shadows
    torus[1].receiveShadow = true // objects need to be configured to cast or receive shadows
    torus[2].receiveShadow = true // objects need to be configured to cast or receive shadows
    torus[3].receiveShadow = true // objects need to be configured to cast or receive shadows
    torus[4].receiveShadow = true // objects need to be configured to cast or receive shadows
    ...
    spotLightFolder.add(data, "shadowMapSizeWidth", [256, 512, 1024, 2048, 4096]).onChange(() => updateShadowMapSize()) // increase or decrease shadow quality (4096 is max you can go)
    spotLightFolder.add(data, "shadowMapSizeHeight", [256, 512, 1024, 2048, 4096]).onChange(() => updateShadowMapSize()) // increase or decrease shadow quality (4096 is max you can go)
